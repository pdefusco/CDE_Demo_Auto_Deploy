...
echo "Creating Spark Job iceberg_mergeinto"
...
echo "Creating Spark Job iceberg_metadata_queries"
...
echo "Creating Airflow Resource"
cde resource create --name cde_airflow_files
echo "Uploading Airflow Dependency to Airflow Resource"
cde resource upload --name cde_airflow_files --local-path username.conf
rm username.conf

echo "Creating Airflow Job airflow_orchestration"
...
# DELETE SETUP JOB
echo "Delete Spark Job table_setup"
